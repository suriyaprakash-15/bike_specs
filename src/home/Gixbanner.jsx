    ...
    <Carousel style={carouselStyles}>
      <Carousel.Item>
        ...
        //   src={`${process.env.PUBLIC_URL}/image/Nature1.jpg`}
          src={`${process.env.PUBLIC_URL}/Bannerimg/gixxer1.jpg`}  
          alt="First slide" 
          style={imageStyles}
        />
      </Carousel.Item>
      <Carousel.Item>
        ...
        //   src={`${process.env.PUBLIC_URL}/image/Nature2.jpg`}
          src={`${process.env.PUBLIC_URL}/Bannerimg/gixxer2.jpg`}  
          alt="Second slide" 
          style={imageStyles}
        />
      </Carousel.Item>
      <Carousel.Item>
        ...
        //   src={`${process.env.PUBLIC_URL}/image/Nature3.jpg`} 
          src={`${process.env.PUBLIC_URL}/Bannerimg/gixxer3.jpg`} 
          alt="Third slide" 
          style={imageStyles}
        />
      </Carousel.Item>
      <Carousel.Item>
        <img 
          className="d-block w-100" 
        //   src={`${process.env.PUBLIC_URL}/image/Nature3.jpg`} 
          src={`${process.env.PUBLIC_URL}/Bannerimg/gixxer4.jpg`} 
          alt="Fourth slide" 
          style={imageStyles}
        />
      </Carousel.Item>
